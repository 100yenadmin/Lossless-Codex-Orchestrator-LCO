...
The core Codex recall, M9 handoff paths, Codex Autonomy Cockpit, and Eva Operating Picture P0 paths are no longer the main gap. The current gap is external tester reliability: fresh npm install, package/gateway setup diagnosis, docs truth, release gates, public-safe scorecards, and a clear line between completed P0 cards and deferred P1 source adapters.

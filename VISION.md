...
The stable 1.0.0 package has shipped on npm `latest` and the GitHub Release is published. The current product/eval target is the post-GA Desktop visibility lane: prove or bound whether Codex CLI/direct-protocol/app-server actions are reflected in Codex Desktop without restart, then route CUA/Peekaboo fallback proof only if needed. The active trackers are Desktop parity [#307](https://github.com/100yenadmin/Lossless-Codex-Orchestrator-LCO/issues/307), desktop fallback [#308](https://github.com/100yenadmin/Lossless-Codex-Orchestrator-LCO/issues/308), and the operating loop [#16](https://github.com/100yenadmin/Lossless-Codex-Orchestrator-LCO/issues/16).
...
- Route #308 CUA/Peekaboo fallback only when #307 shows Desktop visibility is missing, stale, refresh-required, restart-required, or unknown.

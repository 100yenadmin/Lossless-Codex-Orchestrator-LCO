...
0.1.0-beta.23 was an early beta release in the LCO historical archive. This page is kept concise for public changelog readers. Detailed engineering history lives in GitHub issues, pull requests, QA reports, and maintainer runbooks.

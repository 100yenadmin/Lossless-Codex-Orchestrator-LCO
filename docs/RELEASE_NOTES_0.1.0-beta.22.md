...
- #160 exposes the action-bound proof checklist to OpenClaw callers: backend, target app/window, action hash, approval ref, permission state, focus before/after, and public-safe observation.

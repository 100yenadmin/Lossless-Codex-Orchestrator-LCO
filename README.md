...
- classifies active threads as running, blocked, stale, needs-nudge, or unknown
  from public-safe read-only signals, including attention coverage,
  non-executed read-only probe recommendations, and non-executed control
  dry-run recommendations for safe nudge handoff

...
function mainUsageText(): string {
  return [
    ...
    "  loo release ga-smoke --evidence-dir path --package-version version --candidate-sha sha [--allow-setup-required] [--claim-scope codex-live-control|codex-read-search-expand-dry-run|codex-working-app-proof] [--strict]",

...
export const LOO_COMMAND_POLICY: Record<string, LooCommandSafety> = {
  ...
  loo_prepared_state: readOnly("local_index"),
  ...
  loo_watchers: readOnly("structured_operating_inputs"),
  ...
  loo_operating_picture: readOnly("structured_operating_inputs"),
  ...
  loo_codex_extract: readOnly("local_index"),
  ...
  loo_desktop_proof: readOnly("desktop_fallback"),

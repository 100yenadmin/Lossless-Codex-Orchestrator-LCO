  ...
  socket.on("data", (chunk) => {
    ...
    for (const raw of parsed.messages) {
      ...
      if (message.method === "tools.invoke") {
        ...
        if (name === "loo_audit_tail") output = { records: [{ id: "loo_audit_bacced01", live: false, paramsHash: "a".repeat(64) }, { id: "loo_audit_feed1234", approvalAuditId: "loo_audit_bacced01", live: true, paramsHash: "a".repeat(64) }] };

...
Milestone 7 working-app proof scenarios live in `../v1.1/`. Those contracts
require runtime proof markers and must not be treated as complete from this
dry-run runner alone.
